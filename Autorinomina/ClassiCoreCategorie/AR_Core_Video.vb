...
Public Class AR_Core_Video
    ...
    Public Sub New(_OwnerWindow As Window)
        ...
        Coll_TerminiBlackList.AddRange(XmlSerialization.ReadFromXmlFile(Of ItemTermine)(DataPath & "\" & "BlackList_CATEGORIA_video.xml", "BlackList"))
        Coll_TerminiSostituzioni.AddRange(XmlSerialization.ReadFromXmlFile(Of ItemTermine)(DataPath & "\" & "Sostituzioni_CATEGORIA_video.xml", "Sostituzioni"))
    ...
    Public Overrides Function RunCore(ByVal PathFile As String, ByVal NumeroSequenziale As Integer, ByVal LivePreview As Boolean, ByVal PaddingLenght As Integer, ByVal Optional overrideTipoFiltro As String = Nothing) As String
        ...
        If InfoRichiesteStruttura.Contains("AR_") Then InfoFiltrate = Filtro_Generico(PathFile, "video", Coll_TerminiBlackList, Coll_TerminiSostituzioni, True)
        ...
        Dim StileMaiuscoleMinuscole As Integer = Integer.Parse(XMLSettings_Read("CATEGORIA_video_config_StileMaiuscoleMinuscole"))
        ...
        If XMLSettings_Read("CATEGORIA_video_config_SostituzioneTermini").Equals("True") Then
